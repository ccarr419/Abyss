...
declare class HGGifFactory extends TextureFactory { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): HGGifFactory;
	static Find(Outer: UObject, ResourceName: string): HGGifFactory;
	static StaticClass: any;
	static GetClassObject(): Class;
	static GetDefaultObject(): HGGifFactory;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HGGifFactory;
